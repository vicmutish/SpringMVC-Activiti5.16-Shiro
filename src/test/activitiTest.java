...
import zml.dao.IJdbcDao;
import zml.entity.ProcessDefine;
import zml.entity.ProcessModel;
		...
		for(Map<String, Object> map : list) {
			...
			for(ProcessDefine proceDef : defineList) {
				...
				for(Map<String, Object> procInstMap : procInstlist) {
					zml.entity.ProcessInstance processInstance = (zml.entity.ProcessInstance) this.setValToObj(new zml.entity.ProcessInstance(), procInstMap);
